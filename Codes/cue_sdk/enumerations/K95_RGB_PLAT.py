...
class CLK(CEnum, metaclass=KeywordMeta):
    ...
    SETUP for K95 RGB Platnium , Void Pro , Glaive RGB , MM800
    """
    ...
    This is new LED bar that is included in K95 RGB Platnium one. 
    I had to just brute force this in order to find out those numbers.
    Seriously. Corsair... :(
    It is confirmed that there are 19 LEDs in the Bar .
    '''
    ...
    '''
    + PyPheperial by Gooday2die
    This is diffrent from Original K95 Keys. (With 18 macro keys)
    In K95 RGB the nubmer is almost random.
    Took a lot of time for me to find this out by hand.
    Really.
    I typed from 120 to 150 to find those.
    Please Corsair.... :(
    '''
    ...
    MM800_2 = 156 # Mousepad LED #1 from left top.
    MM800_3 = 157 # Mousepad LED #1 from left top.
    MM800_4 = 158 # Mousepad LED #1 from left top.
    MM800_5 = 159 # Mousepad LED #1 from left top.
    MM800_6 = 160 # Mousepad LED #1 from left top.
    MM800_7 = 161 # Mousepad LED #1 from left top.
    MM800_8 = 162 # Mousepad LED #1 from left top.
    MM800_9 = 163 # Mousepad LED #1 from left top.
    MM800_10 = 164 # Mousepad LED #1 from left top.
    MM800_11 = 165 # Mousepad LED #1 from left top.
    MM800_12 = 166 # Mousepad LED #1 from left top.
    MM800_13 = 167 # Mousepad LED #1 from left top.
    MM800_14 = 168 # Mousepad LED #1 from left top.
    MM800_15 = 169 # Mousepad LED #1 from left top.

    '''
    + PyPheperial by Gooday2die
    For MM800
    I had to find all the nubmer by brute force.
    It has been confirmed that there are 15 LED zones in the pad by Corsair. 
    Please Corsair... Give us sources... :(
    '''
